...
class LoginSignupContract:
    ...
    def register(self, w3, account_address, private_key, username, password):
        ...
        login_signup_contract_2 = w3.eth.contract(address=login_signup_tx_receipt['contractAddress'], abi=self.__abi)
    ...
    def login(self, record, w3):
        ...
        login_signup_contract_2 = w3.eth.contract(address=login_signup_contract_address, abi=self.__abi)
